...
const AddArticle = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post("http://localhost:5001/articles", formData, {
        headers: {
      ...
      setMessage(`Erreur lors de l'ajout de l'article: ${error.response ? error.response.data.message : error.message}`);
    }
  };
