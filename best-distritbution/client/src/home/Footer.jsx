...
export default function Footer() {
  ...
  return (
    ...
    <div >
        <div className="pt-1 pb-4 grid grid-cols-12 gap-x-5 gap-y-8">
            <div className="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-white-600 to-green-600 rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
                
            <div className="flex justify-center lg:justify-start">

      <img className='w-40 ' src={logo} alt="Logo" />
    </div>
                <p className="text-left text-black-200 pl-12">Nous rendons la transition écologique simple et efficace avec notre gamme de sacs biodégradables.</p>
                        ...
                        <svg className="w-[1.25rem] h-[1.125rem]" viewBox="0 0 15 15" fill="none"
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_9147_17049" x1="14.6041" y1="1.67072"
                                    ...
                                    <stop offset="0.993738" stopColor="#006A4E" />
                                </linearGradient>
                            </defs>
                        </svg>
    ...
    <h4 className="text-lg text-gray-900 font-bold mb-9">Contactez nous</h4>
    <ul className="text-gray-900 transition-all duration-500 grid gap-6">
        <li className="flex items-center gap-2">
            <IoIosMail className="text-green-700 w-5 h-auto" />
            <span>imedassaibi@best-distribution.com</span>
        </li>
        <li className="flex items-center gap-2">
            <FaPhoneAlt className="text-green-700 w-5 h-auto" />
            <span>06 09 99 98 02</span>
        </li>
        <li className="flex items-center gap-2">
            <IoLocationSharp className="text-green-700 w-14 h-auto" />
            <span>824611180-CENTRE D'AFFAIRES LES ARCADES
            , 440 CLOS DE LA COURTINE 93160 NOISY-LE-GRAND</span>
        </li>
    </ul>
</div>

            <div className="block xl:py-8 px-10 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
                <h4 className="text-lg text-gray-900 font-bold mb-9 text-center xl:text-left">Liens rapides</h4>
                <div className="flex gap-6 xl:gap-12 max-xl:justify-center">
                  <ul className="text-gray-600 transition-all duration-500 grid gap-6">
                    <li className="hover:underline me-4 md:me-6" onClick={() => navigate('/')}>Accueil</li>
                    <li className="hover:underline me-4 md:me-6" onClick={() => navigate('/apropos')}>A propos de nous</li>
                    <li className="hover:underline me-4 md:me-6" onClick={() => navigate('/Contacter-Nous')}>Contact</li>
                    <li className="hover:underline me-4 md:me-6" onClick={() => navigate('/Catalogue')}>Catalogue</li>
                    <li className="hover:underline me-4 md:me-6" onClick={() => navigate('/Devis')}>Demande un devis</li>
                  </ul>
                </div>
            </div>
            <div className="block xl:py-4 col-span-full md:col-span-4 xl:col-span-3">
                <div className="grid gap-7 ">
                    <button type="submit"
                    onClick={handleLogin}
                        className="flex gap-2 justify-center items-center py-3.5 px-7 rounded-full text-white bg-green-900 shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-green-700">Se connecter<svg
