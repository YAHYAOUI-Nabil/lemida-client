...
const Navbar = () => {
  ...
  // Vérifiez si l'utilisateur est authentifié (par exemple, vérification du token dans le localStorage)
    ...
    <div className="bg-gray-100">
      <div className='flex justify-between items-center p-4 bg-white shadow-md'>
        ...
        <div className='hidden md:flex flex-col items-center gap-2 text-gray-700'>
          ...
          <Link to="/Catalogue" className="hover:text-green-700 flex items-center gap-2 hover:border-b-2 hover:border-green-700">
