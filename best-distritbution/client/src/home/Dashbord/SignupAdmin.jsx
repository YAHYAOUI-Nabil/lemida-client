...
const SignupAdmin = () => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const response = await fetch('http://51.83.69.195:6000/api/auth/signup', {
                method: 'POST',
                headers: {
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <div className="flex items-center justify-center">
                        <img src={logo} onClick={handleHome} alt="Logo" className="h-40 w-auto" />
                    </div>
                </div>
    ...
    <div className="space-y-5">
        ...
        <div>
            <label htmlFor="email" className="text-base font-medium text-gray-900">Adresse email</label>
            <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="text-center">
            <p className="text-base text-gray-600">
                <a onClick={handleLogin} title="" className="font-medium text-blue-500 transition-all duration-200 hover:text-orange-600 hover:underline">
                    Se Connecter
                </a>
            </p>
        </div>
