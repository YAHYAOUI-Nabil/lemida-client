...
const Devis = () => {
  ...
  const validate = () => {
    ...
    if (!formData.informations)
      tempErrors.informations = "Informations complémentaires sont requises.";
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      axios
        .post("http://51.83.69.195:6060/api/devis", formData)
        .then((res) => {
    ...
    <section className="dark:bg-slate-800" id="devis">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4 text-center">
          <h1 className="text-3xl font-bold text-green-700 dark:text-white pb-20">
            Demande de devis
          </h1>
        </div>
        <form
        ...
        >
              ...
              <div className="mt-2">
                <label className="inline-flex items-center">
                  <input
                    ...
                    checked={formData.article.includes(
                      "Sac biodégradable 1   "
                    )}
                    onChange={handleChange}
          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            />
            {errors.informations && (
              <p className="text-red-500 text-xs">{errors.informations}</p>
            )}
          </div>
          <div className="md:col-span-2 lg:col-span-3">
            <button
              type="submit"
              className="w-32 bg-green-800 text-white px-6 py-3 font-xl rounded-md"
            >
              Envoyer
            </button>
          </div>
