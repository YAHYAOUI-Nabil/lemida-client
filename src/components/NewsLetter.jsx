      ...
      <div className="flex flex-col gap-4 items-center py-5">
        ...
        <div className="md:w-[682px] w-[350px]">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full h-[50px] px-[15px] py-1.5 rounded-full bg-footer_background_color hover:bg-[#20C997] transition-all duration-500 ease-in-out font-medium text-white"
            >
              S'inscrire
            </button>
          </form>
