...
const MostSeenTrainings = () => {
  return (
    <section className="flex flex-col md:gap-6 gap-6 md:px-desktop_padding sm:px-tablet_padding px-mobile_padding">
      <div className="flex justify-center gap-1 items-center shrink-0 self-stretch h-12">
        <p className="text-lg font-bold text-center leading-[90px] font-[Poppins]">
