...
const TopCategories = () => {
  ...
  return (
    <div className="my-16 md:px-desktop_padding sm:px-tablet_padding px-mobile_padding">
      <h1 className="font-bold md:text-3xl text-xl text-center lg:mb-12 mb-8">
        ...
        >
          {categories.map((category) => {
            return (
              <div
                key={category.name}
                className="relative flex items-center justify-center w-52 min-w-52 h-52 rounded-full bg-[#2a42da] cursor-pointer"
              >
                <div className="">
