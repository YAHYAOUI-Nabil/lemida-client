...
const Recap = () => {
  return (
    <div className="grid lg:grid-cols-4 grid-cols-2 gap-4 lg:divide-x w-fit py-4 px-2 md:px-8 z-10 -mt-12 mx-auto rounded-md bg-white shadow-2xl">
      <div className="flex flex-col gap-2 sm:px-4 px-2 justify-center items-center text-center text-gray-600">
        <p className="lg:text-lg sm:text-base text-sm font-bold">Contenus</p>
        <p className="sm:text-base text-sm">4 sections</p>
      </div>
